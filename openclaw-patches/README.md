...
- **UI Bundle Patch** (`control-ui/assets/index-qROWRwaR.js`) — Patched compiled UI to show discovered provider models in `/chat` and `/agents` dropdowns, and use `config.patch` for saves.
...
cp openclaw-patches/control-ui/assets/index-qROWRwaR.js /usr/lib/node_modules/openclaw/dist/control-ui/assets/
