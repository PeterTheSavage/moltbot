    ...
    <div class="chat-controls">
      ...
      <label class="field" style="max-width:180px;margin-right:8px;flex-shrink:1;flex-grow:0">
        <select
          ...
          ?disabled=${!e.connected}
          @change=${async u=>{const g=u.target.value;if(!e.client||!e.connected)return;try{const h=e.configSnapshot?.hash;if(h){await e.client.request("config.patch",{raw:tn({agents:{defaults:{model:{primary:g||null}}}}),baseHash:h});await Le(e)}}catch(h){e.lastError=String(h)}}}
        >
