...
`} function ur(e, t, n) { if (t.length === 0) return; let s = e; for (let a = 0; a < t.length - 1; a += 1) { const o = t[a], l = t[a + 1]; if (typeof o == "number") { if (!Array.isArray(s)) return; s[o] == null && (s[o] = typeof l == "number" ? [] : {}), s = s[o] } else { if (typeof s != "object" || s == null) return; const c = s; c[o] == null && (c[o] = typeof l == "number" ? [] : {}), s = c[o] } } const i = t[t.length - 1]; if (typeof i == "number") { Array.isArray(s) && (s[i] = n); return } typeof s == "object" && s != null && (s[i] = n) } function gr(e, t) { if (t.length === 0) return; let n = e; for (let i = 0; i < t.length - 1; i += 1) { const a = t[i]; if (typeof a == "number") { if (!Array.isArray(n)) return; n = n[a] } else { if (typeof n != "object" || n == null) return; n = n[a] } if (n == null) return } const s = t[t.length - 1]; if (typeof s == "number") { Array.isArray(n) && n.splice(s, 1); return } typeof n == "object" && n != null && delete n[s] } async function Ee(e) { if (!(!e.client || !e.connected)) { e.configLoading = !0, e.lastError = null; try { const t = await e.client.request("config.get", {}); Ac(e, t) } catch (t) { e.lastError = String(t) } finally { e.configLoading = !1 } } } async function pr(e) { if (!(!e.client || !e.connected) && !e.configSchemaLoading) { e.configSchemaLoading = !0; try { const t = await e.client.request("config.schema", {}); Sc(e, t) } catch (t) { e.lastError = String(t) } finally { e.configSchemaLoading = !1 } } } function Sc(e, t) { e.configSchema = t.schema ?? null, e.configUiHints = t.uiHints ?? {}, e.configSchemaVersion = t.version ?? null } function Ac(e, t) { e.configSnapshot = t; const n = typeof t.raw == "string" ? t.raw : t.config && typeof t.config == "object" ? Lt(t.config) : e.configRaw; !e.configFormDirty || e.configFormMode === "raw" ? e.configRaw = n : e.configForm ? e.configRaw = Lt(e.configForm) : e.configRaw = n, e.configValid = typeof t.valid == "boolean" ? t.valid : null, e.configIssues = Array.isArray(t.issues) ? t.issues : [], e.configFormDirty || (e.configForm = pt(t.config ?? {}), e.configFormOriginal = pt(t.config ?? {}), e.configRawOriginal = n) } async function Mn(e) { if (!(!e.client || !e.connected)) { e.configSaving = !0, e.lastError = null; try { const n = e.configSnapshot?.hash; if (!n) { e.lastError = "Config hash missing; reload and retry."; return } if (e.configFormMode === "form" && e.configForm && e.configFormOriginal) { const _diff = (function _d(a, b) { if (a === b) return undefined; if (!a || !b || typeof a !== "object" || typeof b !== "object" || Array.isArray(a) || Array.isArray(b)) return b; const r = {}; let has = false; for (const k of new Set([...Object.keys(a), ...Object.keys(b)])) { if (!(k in b)) { r[k] = null; has = true; } else { const v = _d(a[k], b[k]); if (v !== undefined) { r[k] = v; has = true; } } } return has ? r : undefined; })(JSON.parse(Lt(e.configFormOriginal)), JSON.parse(Lt(e.configForm))); if (_diff && Object.keys(_diff).length > 0) { await e.client.request("config.patch", { raw: Lt(_diff), baseHash: n }) } } else { await e.client.request("config.set", { raw: e.configFormMode === "form" && e.configForm ? Lt(e.configForm) : e.configRaw, baseHash: n }) } e.configFormDirty = !1, await Ee(e) } catch (t) { e.lastError = String(t) } finally { e.configSaving = !1 } } } async function Cc(e) { if (!(!e.client || !e.connected)) { e.configApplying = !0, e.lastError = null; try { const t = e.configFormMode === "form" && e.configForm ? Lt(e.configForm) : e.configRaw, n = e.configSnapshot?.hash; if (!n) { e.lastError = "Config hash missing; reload and retry."; return } await e.client.request("config.apply", { raw: t, baseHash: n, sessionKey: e.applySessionKey }), e.configFormDirty = !1, await Ee(e) } catch (t) { e.lastError = String(t) } finally { e.configApplying = !1 } } } async function Tc(e) { if (!(!e.client || !e.connected)) { e.updateRunning = !0, e.lastError = null; try { await e.client.request("update.run", { sessionKey: e.applySessionKey }) } catch (t) { e.lastError = String(t) } finally { e.updateRunning = !1 } } } function $e(e, t, n) { const s = pt(e.configForm ?? e.configSnapshot?.config ?? {}); ur(s, t, n), e.configForm = s, e.configFormDirty = !0, e.configFormMode === "form" && (e.configRaw = Lt(s)) } function ze(e, t) { const n = pt(e.configForm ?? e.configSnapshot?.config ?? {}); gr(n, t), e.configForm = n, e.configFormDirty = !0, e.configFormMode === "form" && (e.configRaw = Lt(n)) } function _c(e) { const { values: t, original: n } = e; return t.name !== n.name || t.displayName !== n.displayName || t.about !== n.about || t.picture !== n.picture || t.banner !== n.banner || t.website !== n.website || t.nip05 !== n.nip05 || t.lud16 !== n.lud16 } function Ec(e) {
  const { state: t, callbacks: n, accountId: s } = e, i = _c(t), a = (l, c, u = {}) => {
    ...
    `}, o = () => {
      const l = t.values.picture; return l ? r`
...
`) : ""
  ...
  `}; function xg(e, t) {
  const n = ns(t, e.basePath); return r`
    <a
      href=${n}
  ...
  `} function $g(e) {
  const t = wg(e.hello, e.sessionsResult), n = kg(e.sessionKey, e.sessionsResult, t), s = e.onboarding, i = e.onboarding, a = e.onboarding ? !1 : e.settings.chatShowThinking, o = e.onboarding ? !0 : e.settings.chatFocusMode, l = r`
    <svg
      width="18"
      height="18"
      viewBox="0 0 24 24"
  ...
  `, c = r`
   ...
   `; const _cg = e.configForm ?? e.configSnapshot?.config, _caid = e.agentsSelectedId ?? e.agentsList?.defaultId ?? e.agentsList?.agents?.[0]?.id ?? null, _caf = _caid ? os(_cg, _caid) : null, _cmv = _caf ? lo(_caf.entry?.model) || (Gt(_caf.entry?.model) !== "-" ? ro(Gt(_caf.entry?.model)) : null) : null, _cdv = _caf ? lo(_caf.defaults?.model) || (Gt(_caf.defaults?.model) !== "-" ? ro(Gt(_caf.defaults?.model)) : null) : null, _csv = _cmv ?? _cdv ?? null, _cmopts = Qg(_cg), _cisDefault = !!(e.agentsList?.defaultId && _caid === e.agentsList?.defaultId); return r`
    <div class="chat-controls">
      ...
      <label class="field chat-controls__model">
        <select
          .value=${_csv ?? ""}
          ?disabled=${!e.connected || e.configLoading || e.configSaving || !_cg}
          @change=${async u => { if (!_caid || !_cg) return; const _nv = u.target.value || null, _al = _cg.agents?.list; let _ai = -1; if (Array.isArray(_al)) { _ai = _al.findIndex(_x => _x && typeof _x === "object" && "id" in _x && _x.id === _caid) } if (_ai >= 0) { const _mp = ["agents", "list", _ai, "model"]; if (!_nv) { ze(e, _mp) } else { const _cm = _al[_ai]?.model; if (_cm && typeof _cm === "object" && !Array.isArray(_cm)) { const _fb = _cm.fallbacks; $e(e, _mp, { primary: _nv, ...Array.isArray(_fb) ? { fallbacks: _fb } : {} }) } else { $e(e, _mp, _nv) } } } else { const _dp = ["agents", "defaults", "model"]; if (!_nv) { ze(e, _dp) } else { const _dm = _cg.agents?.defaults?.model; if (_dm && typeof _dm === "object" && !Array.isArray(_dm)) { const _fb = _dm.fallbacks; $e(e, _dp, { primary: _nv, ...Array.isArray(_fb) ? { fallbacks: _fb } : {} }) } else { $e(e, _dp, _nv) } } } await Mn(e) }}
          title="Change model for this agent"
        >
          ${_cisDefault ? v : r`<option value="">
                    ${_cdv ? `Default (${_cdv})` : "Inherit default"}
                  </option>`}
          ${(() => { const _s = _csv ? _cmopts.some(_o => _o.value === _csv) : !1; return _csv && !_s ? r`<option value=${_csv}>Current (${_csv})</option>` : v })()}
          ${_cmopts.map(_o => r`<option value=${_o.value}>${_o.label}</option>`)}
        </select>
      </label>
      <span class="chat-controls__separator">|</span>
      <button
  ...
  `} function wg(e, t) { const n = e?.snapshot, s = n?.sessionDefaults?.mainSessionKey?.trim(); if (s) return s; const i = n?.sessionDefaults?.mainKey?.trim(); return i || (t?.sessions?.some(a => a.key === "main") ? "main" : null) } function Is(e, t) { const n = t?.label?.trim() || "", s = t?.displayName?.trim() || ""; return n && n !== e ? `${n} (${e})` : s && s !== e ? `${e} (${s})` : e } function kg(e, t, n) { const s = new Set, i = [], a = n && t?.sessions?.find(l => l.key === n), o = t?.sessions?.find(l => l.key === e); if (n && (s.add(n), i.push({ key: n, displayName: Is(n, a || void 0) })), s.has(e) || (s.add(e), i.push({ key: e, displayName: Is(e, o) })), t?.sessions) for (const l of t.sessions) s.has(l.key) || (s.add(l.key), i.push({ key: l.key, displayName: Is(l.key, l) })); return i } const Sg = ["system", "light", "dark"]; function Ag(e) {
  const t = Math.max(0, Sg.indexOf(e.theme)), n = s => i => { const o = { element: i.currentTarget }; (i.clientX || i.clientY) && (o.pointerClientX = i.clientX, o.pointerClientY = i.clientY), e.setTheme(s, o) }; return r`
      ...
      <section class="card agents-sidebar">
        ...
        <div class="agent-list" style="margin-top: 12px;">
          ${t.length === 0 ? r`
                ...
                `: t.map(a => {
    const o = cl(a.id, n), l = as(a, e.agentIdentityById[a.id] ?? null); return r`
                    <button
                      type="button"
  ...
  `} function ep(e, t, n) {
  const s = cl(e.id, t), i = ri(e), a = e.identity?.theme?.trim() || "Agent workspace and routing.", o = as(e, n); return r`
      ...
      <section class="card">
        ...
        ${n.length === 0 ? r`
              ...
              <div class="list" style="margin-top: 16px;">
                ${n.map(i => {
    const a = cp(i.accounts), o = a.total ? `${a.connected}/${a.total} connected` : "no accounts", l = a.configured ? `${a.configured} configured` : "not configured", c = a.total ? `${a.enabled} enabled` : "disabled", u = lp(e.configForm, i.id); return r`
                    <div class="list-item">
                      <div class="list-main">
  ...
  `} function up(e) {
  const t = dl(e.agent, e.configForm, e.agentFilesList, e.defaultId, e.agentIdentity), n = e.jobs.filter(s => s.agentId === e.agent.id); return r`
    <section class="grid grid-cols-2">
  ...
  `} function gp(e) {
  const t = e.agentFilesList?.agentId === e.agentId ? e.agentFilesList : null, n = t?.files ?? [], s = e.agentFileActive ?? null, i = s ? n.find(c => c.name === s) ?? null : null, a = s ? e.agentFileContents[s] ?? "" : "", o = s ? e.agentFileDrafts[s] ?? a : "", l = s ? o !== a : !1; return r`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
  ...
  `} function pp(e, t, n) {
  const s = e.missing ? "Missing" : `${qg(e.size)} · ${V(e.updatedAtMs ?? null)}`; return r`
    <button
      type="button"
  ...
  `} function mp(e, t) {
  const n = e.id === "workspace" || e.id === "built-in"; return r`
  ...
  `} function bp(e, t) {
  const n = t.usingAllowlist ? t.allowSet.has(e.name) : !0, s = [...e.missing.bins.map(a => `bin:${a}`), ...e.missing.env.map(a => `env:${a}`), ...e.missing.config.map(a => `config:${a}`), ...e.missing.os.map(a => `os:${a}`)], i = []; return e.disabled && i.push("disabled"), e.blockedByAllowlist && i.push("blocked by allowlist"), r`
  ...
  `}; function Ke(e) {
  const { schema: t, value: n, path: s, hints: i, unsupported: a, disabled: o, onPatch: l } = e, c = e.showLabel ?? !0, u = De(t), g = Se(s, i), p = g?.label ?? t.title ?? We(String(s.at(-1))), h = g?.help ?? t.description, d = rs(s); if (a.has(d)) return r`<div class="cfg-field cfg-field--error">
      <div class="cfg-field__label">${p}</div>
      <div class="cfg-field__error">Unsupported schema node. Use Raw mode.</div>
    </div>`; if (t.anyOf || t.oneOf) {
    const m = (t.anyOf ?? t.oneOf ?? []).filter(_ => !(_.type === "null" || Array.isArray(_.type) && _.type.includes("null"))); if (m.length === 1) return Ke({ ...e, schema: m[0] }); const S = _ => { if (_.const !== void 0) return _.const; if (_.enum && _.enum.length === 1) return _.enum[0] }, k = m.map(S), $ = k.every(_ => _ !== void 0); if ($ && k.length > 0 && k.length <= 5) {
      const _ = n ?? t.default; return r`
        <div class="cfg-field">
    ...
    const f = t.enum; if (f.length <= 5) {
      ...
      `} return go({ ...e, options: f, value: n ?? t.default })
  } if (u === "object") return Sp(e); if (u === "array") return Ap(e); if (u === "boolean") {
    const f = typeof n == "boolean" ? n : typeof t.default == "boolean" ? t.default : !1; return r`
  ...
  `} function uo(e) {
  const { schema: t, value: n, path: s, hints: i, disabled: a, onPatch: o, inputType: l } = e, c = e.showLabel ?? !0, u = Se(s, i), g = u?.label ?? t.title ?? We(String(s.at(-1))), p = u?.help ?? t.description, h = u?.sensitive ?? yp(s), d = u?.placeholder ?? (h ? "••••" : t.default !== void 0 ? `Default: ${String(t.default)}` : ""), f = n ?? ""; return r`
    <div class="cfg-field">
  ...
  `} function kp(e) {
  const { schema: t, value: n, path: s, hints: i, disabled: a, onPatch: o } = e, l = e.showLabel ?? !0, c = Se(s, i), u = c?.label ?? t.title ?? We(String(s.at(-1))), g = c?.help ?? t.description, p = n ?? t.default ?? "", h = typeof p == "number" ? p : 0; return r`
    <div class="cfg-field">
  ...
  `} function go(e) {
  const { schema: t, value: n, path: s, hints: i, disabled: a, options: o, onPatch: l } = e, c = e.showLabel ?? !0, u = Se(s, i), g = u?.label ?? t.title ?? We(String(s.at(-1))), p = u?.help ?? t.description, h = n ?? t.default, d = o.findIndex(m => m === h || String(m) === String(h)), f = "__unset__"; return r`
    <div class="cfg-field">
      ${c ? r`<label class="cfg-field__label">${g}</label>` : v}
      ${p ? r`<div class="cfg-field__help">${p}</div>` : v}
      <select
  ...
  `} function Ap(e) {
  const { schema: t, value: n, path: s, hints: i, unsupported: a, disabled: o, onPatch: l } = e, c = e.showLabel ?? !0, u = Se(s, i), g = u?.label ?? t.title ?? We(String(s.at(-1))), p = u?.help ?? t.description, h = Array.isArray(t.items) ? t.items[0] : t.items; if (!h) return r`
      <div class="cfg-field cfg-field--error">
  ...
  `} function po(e) {
  const { schema: t, value: n, path: s, hints: i, unsupported: a, disabled: o, reservedKeys: l, onPatch: c } = e, u = $p(t), g = Object.entries(n ?? {}).filter(([p]) => !l.has(p)); return r`
    <div class="cfg-map">
  ...
  if (!e.schema) return r`
    ...
    <div class="config-form config-form--modern">
      ${g ? (() => {
      const { sectionKey: p, subsectionKey: h, schema: d } = g, f = Se([p, h], e.uiHints), m = f?.label ?? d.title ?? We(h), S = f?.help ?? d.description ?? "", k = n[p], $ = k && typeof k == "object" ? k[h] : void 0, A = `config-section-${p}-${h}`; return r`
            ...
            `})() : u.map(([p, h]) => {
        const d = Qi[p] ?? { label: p.charAt(0).toUpperCase() + p.slice(1), description: h.description ?? "" }; return r`
  ...
  `} function Fp(e) {
  const t = fl(e.schema), n = t.schema; if (!n) return r`
    ...
    ${Dp(a)}
  `} function qe(e) {
  const { channelId: t, props: n } = e, s = n.configSaving || n.configSchemaLoading; return r`
  ...
  `} function Np(e) {
  const { props: t, discord: n, accountCountLabel: s } = e; return r`
    <div class="card">
  ...
  `} function Op(e) {
  const { props: t, googleChat: n, accountCountLabel: s } = e; return r`
    <div class="card">
  ...
  `} function Bp(e) {
  const { props: t, imessage: n, accountCountLabel: s } = e; return r`
    <div class="card">
  ...
  `} function vo(e) { return e ? e.length <= 20 ? e : `${e.slice(0, 8)}...${e.slice(-8)}` : "n/a" } function Up(e) {
  const { props: t, nostr: n, nostrAccounts: s, accountCountLabel: i, profileFormState: a, profileFormCallbacks: o, onEditProfile: l } = e, c = s[0], u = n?.configured ?? c?.configured ?? !1, g = n?.running ?? c?.running ?? !1, p = n?.publicKey ?? c?.publicKey, h = n?.lastStartAt ?? c?.lastStartAt ?? null, d = n?.lastError ?? c?.lastError ?? null, f = s.length > 1, m = a != null, S = $ => {
    const A = $.publicKey, C = $.profile, _ = C?.displayName ?? C?.name ?? $.name ?? $.accountId; return r`
    ...
    `}, k = () => {
      if (m && o) return Ec({ state: a, callbacks: o, accountId: s[0]?.accountId ?? "default" }); const $ = c?.profile ?? n?.profile, { name: A, displayName: C, about: _, picture: T, nip05: I } = $ ?? {}, z = A || C || _ || T || I; return r`
  ...
  `} function Kp(e) {
  const { props: t, slack: n, accountCountLabel: s } = e; return r`
    <div class="card">
  ...
  `} function Wp(e) {
  const { props: t, telegram: n, telegramAccounts: s, accountCountLabel: i } = e, a = s.length > 1, o = l => {
    const u = l.probe?.bot?.username, g = l.name || l.accountId; return r`
      <div class="account-card">
        <div class="account-card-header">
  ...
  `} function qp(e) {
  const { props: t, whatsapp: n, accountCountLabel: s } = e; return r`
    <div class="card">
  ...
  `} function Gp(e) {
  const t = e.snapshot?.channels, n = t?.whatsapp ?? void 0, s = t?.telegram ?? void 0, i = t?.discord ?? null, a = t?.googlechat ?? null, o = t?.slack ?? null, l = t?.signal ?? null, c = t?.imessage ?? null, u = t?.nostr ?? null, p = Vp(e.snapshot).map((h, d) => ({ key: h, enabled: zp(h, e), order: d })).toSorted((h, d) => h.enabled !== d.enabled ? h.enabled ? -1 : 1 : h.order - d.order); return r`
    <section class="grid grid-cols-2">
...
`+ be), xt && kn([H, ce, E], Ue => { be = Ot(be, Ue, " ") }), C && gn ? C.createHTML(be) : be
  ...
  let s = e.match(n.other.indentCodeCompensation); if (s === null) return t; let i = s[1]; return t.split(`
`).map(a => { let o = a.match(n.other.beginningSpace); if (o === null) return a; let [l] = o; return l.length >= i.length ? a.slice(i.length) : a }).join(`
`)
} var jn = class {
  options; rules; lexer; constructor(e) { this.options = e || yt } space(e) { let t = this.rules.block.newline.exec(e); if (t && t[0].length > 0) return { type: "space", raw: t[0] } } code(e) {
    let t = this.rules.block.code.exec(e); if (t) {
      let n = t[0].replace(this.rules.other.codeRemoveIndent, ""); return {
        type: "code", raw: t[0], codeBlockStyle: "indented", text: this.options.pedantic ? n : jt(n, `
`)
      }
    }
...
`)
    ...
    let t = this.rules.block.blockquote.exec(e); if (t) {
      let n = jt(t[0], `
`).split(`
`), s = "", i = "", a = []; for (; n.length > 0;) {
        let o = !1, l = [], c; for (c = 0; c < n.length; c++)if (this.rules.other.blockquoteStart.test(n[c])) l.push(n[c]), o = !0; else if (!o) l.push(n[c]); else break; n = n.slice(c); let u = l.join(`
`), g = u.replace(this.rules.other.blockquoteSetextReplace, `
    $1`).replace(this.rules.other.blockquoteSetextReplace2, ""); s = s ? `${s}
${u}` : u, i = i ? `${i}
${g}` : g; let p = this.lexer.state.top; if (this.lexer.state.top = !0, this.lexer.blockTokens(g, a, !0), this.lexer.state.top = p, n.length === 0) break; let h = a.at(-1); if (h?.type === "code") break; if (h?.type === "blockquote") {
          let d = h, f = d.raw + `
`+ n.join(`
`), m = this.blockquote(f); a[a.length - 1] = m, s = s.substring(0, s.length - d.raw.length) + m.raw, i = i.substring(0, i.length - d.text.length) + m.text; break
        } else if (h?.type === "list") {
          let d = h, f = d.raw + `
`+ n.join(`
...
`); continue
    ...
    let t = this.rules.block.list.exec(e); if (t) {
      let n = t[1].trim(), s = n.length > 1, i = { type: "list", raw: "", ordered: s, start: s ? +n.slice(0, -1) : "", loose: !1, items: [] }; n = s ? `\\d{1,9}\\${n.slice(-1)}` : `\\${n}`, this.options.pedantic && (n = s ? n : "[*+-]"); let a = this.rules.other.listItemRegex(n), o = !1; for (; e;) {
        let c = !1, u = "", g = ""; if (!(t = a.exec(e)) || this.rules.block.hr.test(e)) break; u = t[0], e = e.substring(u.length); let p = t[2].split(`
...
`, e = e.substring(h.length + 1), c = !0), !c) {
          let m = this.rules.other.nextBulletRegex(f), S = this.rules.other.hrRegex(f), k = this.rules.other.fencesBeginRegex(f), $ = this.rules.other.headingBeginRegex(f), A = this.rules.other.htmlBeginRegex(f); for (; e;) {
            let C = e.split(`
...
`, e = e.substring(C.length + 1), p = _.slice(f)
    ...
    let t = this.rules.block.table.exec(e); if (!t || !this.rules.other.tableDelimiter.test(t[2])) return; let n = Eo(t[1]), s = t[2].replace(this.rules.other.tableAlignChars, "").split("|"), i = t[3]?.trim() ? t[3].replace(this.rules.other.tableRowBlankLine, "").split(`
...
`? t[1].slice(0, -1) : t[1]; return { type: "paragraph", raw: t[0], text: n, tokens: this.lexer.inline(n) }
  ...
  tokens; options; state; inlineQueue; tokenizer; constructor(t) { this.tokens = [], this.tokens.links = Object.create(null), this.options = t || yt, this.options.tokenizer = this.options.tokenizer || new jn, this.tokenizer = this.options.tokenizer, this.tokenizer.options = this.options, this.tokenizer.lexer = this, this.inlineQueue = [], this.state = { inLink: !1, inRawBlock: !1, top: !0 }; let n = { other: he, block: An.normal, inline: Ht.normal }; this.options.pedantic ? (n.block = An.pedantic, n.inline = Ht.pedantic) : this.options.gfm && (n.block = An.gfm, this.options.breaks ? n.inline = Ht.breaks : n.inline = Ht.gfm), this.tokenizer.rules = n } static get rules() { return { block: An, inline: Ht } } static lex(t, n) { return new vi(n).lex(t) } static lexInline(t, n) { return new vi(n).inlineTokens(t) } lex(t) {
    t = t.replace(he.carriageReturn, `
`), this.blockTokens(t, this.tokens); for (let n = 0; n < this.inlineQueue.length; n++) { let s = this.inlineQueue[n]; this.inlineTokens(s.src, s.tokens) } return this.inlineQueue = [], this.tokens
  } blockTokens(t, n = [], s = !1) {
    for (this.options.pedantic && (t = t.replace(he.tabCharGlobal, "    ").replace(he.spaceLine, "")); t;) {
      let i; if (this.options.extensions?.block?.some(o => (i = o.call({ lexer: this }, t, n)) ? (t = t.substring(i.raw.length), n.push(i), !0) : !1)) continue; if (i = this.tokenizer.space(t)) {
        t = t.substring(i.raw.length); let o = n.at(-1); i.raw.length === 1 && o !== void 0 ? o.raw += `
`: n.push(i); continue
      } if (i = this.tokenizer.code(t)) {
        t = t.substring(i.raw.length); let o = n.at(-1); o?.type === "paragraph" || o?.type === "text" ? (o.raw += (o.raw.endsWith(`
`) ? "" : `
`) + i.raw, o.text += `
`+ i.text, this.inlineQueue.at(-1).src = o.text) : n.push(i); continue
      } if (i = this.tokenizer.fences(t)) { t = t.substring(i.raw.length), n.push(i); continue } if (i = this.tokenizer.heading(t)) { t = t.substring(i.raw.length), n.push(i); continue } if (i = this.tokenizer.hr(t)) { t = t.substring(i.raw.length), n.push(i); continue } if (i = this.tokenizer.blockquote(t)) { t = t.substring(i.raw.length), n.push(i); continue } if (i = this.tokenizer.list(t)) { t = t.substring(i.raw.length), n.push(i); continue } if (i = this.tokenizer.html(t)) { t = t.substring(i.raw.length), n.push(i); continue } if (i = this.tokenizer.def(t)) {
        t = t.substring(i.raw.length); let o = n.at(-1); o?.type === "paragraph" || o?.type === "text" ? (o.raw += (o.raw.endsWith(`
`) ? "" : `
`) + i.raw, o.text += `
`+ i.raw, this.inlineQueue.at(-1).src = o.text) : this.tokens.links[i.tag] || (this.tokens.links[i.tag] = { href: i.href, title: i.title }, n.push(i)); continue
      } if (i = this.tokenizer.table(t)) { t = t.substring(i.raw.length), n.push(i); continue } if (i = this.tokenizer.lheading(t)) { t = t.substring(i.raw.length), n.push(i); continue } let a = t; if (this.options.extensions?.startBlock) { let o = 1 / 0, l = t.slice(1), c; this.options.extensions.startBlock.forEach(u => { c = u.call({ lexer: this }, l), typeof c == "number" && c >= 0 && (o = Math.min(o, c)) }), o < 1 / 0 && o >= 0 && (a = t.substring(0, o + 1)) } if (this.state.top && (i = this.tokenizer.paragraph(a))) {
        let o = n.at(-1); s && o?.type === "paragraph" ? (o.raw += (o.raw.endsWith(`
`) ? "" : `
`) + i.raw, o.text += `
`+ i.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = o.text) : n.push(i), s = a.length !== t.length, t = t.substring(i.raw.length); continue
      } if (i = this.tokenizer.text(t)) {
        t = t.substring(i.raw.length); let o = n.at(-1); o?.type === "text" ? (o.raw += (o.raw.endsWith(`
`) ? "" : `
`) + i.raw, o.text += `
`+ i.text, this.inlineQueue.pop(), this.inlineQueue.at(-1).src = o.text) : n.push(i); continue
      } if (t) { let o = "Infinite loop on byte: " + t.charCodeAt(0); if (this.options.silent) { console.error(o); break } else throw new Error(o) }
    } return this.state.top = !0, n
  } inline(t, n = []) { return this.inlineQueue.push({ src: t, tokens: n }), n } inlineTokens(t, n = []) { let s = t, i = null; if (this.tokens.links) { let c = Object.keys(this.tokens.links); if (c.length > 0) for (; (i = this.tokenizer.rules.inline.reflinkSearch.exec(s)) != null;)c.includes(i[0].slice(i[0].lastIndexOf("[") + 1, -1)) && (s = s.slice(0, i.index) + "[" + "a".repeat(i[0].length - 2) + "]" + s.slice(this.tokenizer.rules.inline.reflinkSearch.lastIndex)) } for (; (i = this.tokenizer.rules.inline.anyPunctuation.exec(s)) != null;)s = s.slice(0, i.index) + "++" + s.slice(this.tokenizer.rules.inline.anyPunctuation.lastIndex); let a; for (; (i = this.tokenizer.rules.inline.blockSkip.exec(s)) != null;)a = i[2] ? i[2].length : 0, s = s.slice(0, i.index + a) + "[" + "a".repeat(i[0].length - a - 2) + "]" + s.slice(this.tokenizer.rules.inline.blockSkip.lastIndex); s = this.options.hooks?.emStrongMask?.call({ lexer: this }, s) ?? s; let o = !1, l = ""; for (; t;) { o || (l = ""), o = !1; let c; if (this.options.extensions?.inline?.some(g => (c = g.call({ lexer: this }, t, n)) ? (t = t.substring(c.raw.length), n.push(c), !0) : !1)) continue; if (c = this.tokenizer.escape(t)) { t = t.substring(c.raw.length), n.push(c); continue } if (c = this.tokenizer.tag(t)) { t = t.substring(c.raw.length), n.push(c); continue } if (c = this.tokenizer.link(t)) { t = t.substring(c.raw.length), n.push(c); continue } if (c = this.tokenizer.reflink(t, this.tokens.links)) { t = t.substring(c.raw.length); let g = n.at(-1); c.type === "text" && g?.type === "text" ? (g.raw += c.raw, g.text += c.text) : n.push(c); continue } if (c = this.tokenizer.emStrong(t, s, l)) { t = t.substring(c.raw.length), n.push(c); continue } if (c = this.tokenizer.codespan(t)) { t = t.substring(c.raw.length), n.push(c); continue } if (c = this.tokenizer.br(t)) { t = t.substring(c.raw.length), n.push(c); continue } if (c = this.tokenizer.del(t)) { t = t.substring(c.raw.length), n.push(c); continue } if (c = this.tokenizer.autolink(t)) { t = t.substring(c.raw.length), n.push(c); continue } if (!this.state.inLink && (c = this.tokenizer.url(t))) { t = t.substring(c.raw.length), n.push(c); continue } let u = t; if (this.options.extensions?.startInline) { let g = 1 / 0, p = t.slice(1), h; this.options.extensions.startInline.forEach(d => { h = d.call({ lexer: this }, p), typeof h == "number" && h >= 0 && (g = Math.min(g, h)) }), g < 1 / 0 && g >= 0 && (u = t.substring(0, g + 1)) } if (c = this.tokenizer.inlineText(u)) { t = t.substring(c.raw.length), c.raw.slice(-1) !== "_" && (l = c.raw.slice(-1)), o = !0; let g = n.at(-1); g?.type === "text" ? (g.raw += c.raw, g.text += c.text) : n.push(c); continue } if (t) { let g = "Infinite loop on byte: " + t.charCodeAt(0); if (this.options.silent) { console.error(g); break } else throw new Error(g) } } return n }
}, Kn = class {
  options; parser; constructor(e) { this.options = e || yt } space(e) { return "" } code({ text: e, lang: t, escaped: n }) {
    let s = (t || "").match(he.notSpaceStart)?.[0], i = e.replace(he.endingNewline, "") + `
...
`} hr(e) {
    return `<hr>
`} list(e) {
    let t = e.ordered, n = e.start, s = ""; for (let o = 0; o < e.items.length; o++) { let l = e.items[o]; s += this.listitem(l) } let i = t ? "ol" : "ul", a = t && n !== 1 ? ' start="' + n + '"' : ""; return "<" + i + a + `>
`+ s + "</" + i + `>
`} listitem(e) {
...
`} table(e) {
    let t = "", n = ""; for (let i = 0; i < e.header.length; i++)n += this.tablecell(e.header[i]); t += this.tablerow({ text: n }); let s = ""; for (let i = 0; i < e.rows.length; i++) { let a = e.rows[i]; n = ""; for (let o = 0; o < a.length; o++)n += this.tablecell(a[o]); s += this.tablerow({ text: n }) } return s && (s = `<tbody>${s}</tbody>`), `<table>
<thead>
`+ t + `</thead>
`+ s + `</table>
`} tablerow({ text: e }) {
...
`: ""}*No output — tool completed successfully.*`; t(p)
  ...
  `} function Jh(e, t, n, s) {
  const i = new Date(t).toLocaleTimeString([], { hour: "numeric", minute: "2-digit" }), a = s?.name ?? "Assistant"; return r`
    <div class="chat-group assistant">
      ${oa("assistant", s)}
      <div class="chat-group-messages">
  ...
  `} function Zh(e, t) {
  const n = aa(e.role), s = t.assistantName ?? "Assistant", i = n === "user" ? "You" : n === "assistant" ? s : n, a = n === "user" ? "user" : n === "assistant" ? "assistant" : "other", o = new Date(e.timestamp).toLocaleTimeString([], { hour: "numeric", minute: "2-digit" }); return r`
  ...
  `} function oa(e, t) {
  const n = aa(e), s = t?.name?.trim() || "Assistant", i = t?.avatar?.trim() || "", a = n === "user" ? "U" : n === "assistant" ? s.charAt(0).toUpperCase() || "A" : n === "tool" ? "⚙" : "?", o = n === "user" ? "user" : n === "assistant" ? "assistant" : n === "tool" ? "tool" : "other"; return i && n === "assistant" ? Xh(i) ? r`<img
        class="chat-avatar ${o}"
        src="${i}"
        alt="${s}"
      />`: r`<div class="chat-avatar ${o}">${i}</div>` : r`<div class="chat-avatar ${o}">${a}</div>`
} function Xh(e) { return /^https?:\/\//i.test(e) || /^data:image\//i.test(e) || e.startsWith("/") } function ev(e) {
  return e.length === 0 ? v : r`
  ...
  `; ds([Yn({ type: Number })], It.prototype, "splitRatio", 2); ds([Yn({ type: Number })], It.prototype, "minRatio", 2); ds([Yn({ type: Number })], It.prototype, "maxRatio", 2); It = ds([dr("resizable-divider")], It); const iv = 5e3; function Oo(e) { e.style.height = "auto", e.style.height = `${e.scrollHeight}px` } function av(e) {
  return e ? e.active ? r`
      ...
      >
        ...
        ${p ? r`
              ...
              <div class="chat-sidebar">
                ${tv({
    content: e.sidebarContent ?? null, error: e.sidebarError ?? null, onClose: e.onCloseSidebar, onViewRawText: () => {
      !e.sidebarContent || !e.onOpenSidebar || e.onOpenSidebar(`\`\`\`
${e.sidebarContent}
\`\`\``)
    }
  })}
...
${JSON.stringify(e.issues, null, 2)}</pre
  ...
  `} function vv(e) { const t = ["last", ...e.channels.filter(Boolean)], n = e.form.deliveryChannel?.trim(); n && !t.includes(n) && t.push(n); const s = new Set; return t.filter(i => s.has(i) ? !1 : (s.add(i), !0)) } function mv(e, t) { if (t === "last") return "last"; const n = e.channelMeta?.find(s => s.id === t); return n?.label ? n.label : e.channelLabels?.[t] ?? t } function bv(e) {
  const t = vv(e), s = (e.runsJobId == null ? void 0 : e.jobs.find(a => a.id === e.runsJobId))?.name ?? e.runsJobId ?? "(select a job)", i = e.runs.toSorted((a, o) => o.ts - a.ts); return r`
    <section class="grid grid-cols-2">
      <div class="card">
        <div class="card-title">Scheduler</div>
  ...
  `} function yv(e) {
  const t = e.form; return t.scheduleKind === "at" ? r`
      <label class="field" style="margin-top: 12px;">
        <span>Run at</span>
        <input
          type="datetime-local"
  ...
  `} function xv(e, t) {
  const s = `list-item list-item-clickable cron-job${t.runsJobId === e.id ? " list-item-selected" : ""}`; return r`
  ...
  `} function $v(e) {
  if (e.payload.kind === "systemEvent") return r`<div class="cron-job-detail">
  ...
  `} function Wo(e) { return typeof e != "number" || !Number.isFinite(e) ? "n/a" : V(e) } function wv(e) {
  const t = e.state?.lastStatus ?? "n/a", n = t === "ok" ? "cron-job-status-ok" : t === "error" ? "cron-job-status-error" : t === "skipped" ? "cron-job-status-skipped" : "cron-job-status-na", s = e.state?.nextRunAtMs, i = e.state?.lastRunAtMs; return r`
  ...
  `} function kv(e, t) {
  const n = typeof e.sessionKey == "string" && e.sessionKey.trim().length > 0 ? `${ns("chat", t)}?session=${encodeURIComponent(e.sessionKey)}` : null; return r`
    <div class="list-item">
      <div class="list-main">
  ...
  `} function Sv(e) {
  const n = (e.status && typeof e.status == "object" ? e.status.securityAudit : null)?.summary ?? null, s = n?.critical ?? 0, i = n?.warn ?? 0, a = n?.info ?? 0, o = s > 0 ? "danger" : i > 0 ? "warn" : "success", l = s > 0 ? `${s} critical` : i > 0 ? `${i} warnings` : "No critical issues"; return r`
    <section class="grid grid-cols-2">
      <div class="card">
        <div class="row" style="justify-content: space-between;">
          <div>
  ...
  `} function Av(e) { const t = Math.max(0, e), n = Math.floor(t / 1e3); if (n < 60) return `${n}s`; const s = Math.floor(n / 60); return s < 60 ? `${s}m` : `${Math.floor(s / 60)}h` } function it(e, t) { return t ? r`<div class="exec-approval-meta-row"><span>${e}</span><span>${t}</span></div>` : v } function Cv(e) {
  const t = e.execApprovalQueue[0]; if (!t) return v; const n = t.request, s = t.expiresAtMs - Date.now(), i = s > 0 ? `expires in ${Av(s)}` : "expired", a = e.execApprovalQueue.length; return r`
  ...
  `} function Tv(e) {
  const { pendingGatewayUrl: t } = e; return t ? r`
  ...
  `} function Ev(e) {
  const t = e.lastInputSeconds != null ? `${e.lastInputSeconds}s ago` : "n/a", n = e.mode ?? "unknown", s = Array.isArray(e.roles) ? e.roles.filter(Boolean) : [], i = Array.isArray(e.scopes) ? e.scopes.filter(Boolean) : [], a = i.length > 0 ? i.length > 3 ? `${i.length} scopes` : `scopes: ${i.join(", ")}` : null; return r`
    <div class="list-item">
      <div class="list-main">
  ...
  `} const qo = ["trace", "debug", "info", "warn", "error", "fatal"]; function Lv(e) { if (!e) return ""; const t = new Date(e); return Number.isNaN(t.getTime()) ? e : t.toLocaleTimeString() } function Mv(e, t) { return t ? [e.message, e.subsystem, e.raw].filter(Boolean).join(" ").toLowerCase().includes(t) : !0 } function Iv(e) {
  const t = e.filterText.trim().toLowerCase(), n = qo.some(a => !e.levelFilters[a]), s = e.entries.filter(a => a.level && !e.levelFilters[a.level] ? !1 : Mv(a, t)), i = t || n ? "filtered" : "visible"; return r`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
  ...
  `} function Pv(e) {
  const t = e.devicesList ?? { pending: [], paired: [] }, n = Array.isArray(t.pending) ? t.pending : [], s = Array.isArray(t.paired) ? t.paired : []; return r`
    <section class="card">
      <div class="row" style="justify-content: space-between;">
        <div>
  ...
  `} function Dv(e, t) {
  const n = e.displayName?.trim() || e.deviceId, s = typeof e.ts == "number" ? V(e.ts) : "n/a", i = e.role?.trim() ? `role: ${e.role}` : "role: -", a = e.isRepair ? " · repair" : "", o = e.remoteIp ? ` · ${e.remoteIp}` : ""; return r`
    <div class="list-item">
      <div class="list-main">
  ...
  `} function Fv(e, t) {
  const n = e.displayName?.trim() || e.deviceId, s = e.remoteIp ? ` · ${e.remoteIp}` : "", i = `roles: ${Vs(e.roles)}`, a = `scopes: ${Vs(e.scopes)}`, o = Array.isArray(e.tokens) ? e.tokens : []; return r`
    <div class="list-item">
      <div class="list-main">
        <div class="list-title">${n}</div>
  ...
  `} function Nv(e, t, n) {
  const s = t.revokedAtMs ? "revoked" : "active", i = `scopes: ${Vs(t.scopes)}`, a = V(t.rotatedAtMs ?? t.createdAtMs ?? t.lastUsedAtMs ?? null); return r`
  ...
  `} function Gv(e) {
  const t = e.ready, n = e.target !== "node" || !!e.targetNodeId; return r`
    <section class="card">
      <div class="row" style="justify-content: space-between; align-items: center;">
        <div>
  ...
  `} function Vv(e) {
  const t = e.targetNodes.length > 0, n = e.targetNodeId ?? ""; return r`
    <div class="list" style="margin-top: 12px;">
      <div class="list-item">
        <div class="list-main">
  ...
  return r`
    <div class="row" style="margin-top: 12px; gap: 8px; flex-wrap: wrap;">
      ...
      <div class="row" style="gap: 8px; flex-wrap: wrap;">
        ...
        ${e.agents.map(t => {
    const n = t.name?.trim() ? `${t.name} (${t.id})` : t.id; return r`
            <button
  ...
  `} function Jv(e) {
  const t = ["agents", e.selectedScope, "allowlist"], n = e.allowlist; return r`
  ...
  `} function Zv(e, t, n) {
  const s = t.lastUsedAt ? V(t.lastUsedAt) : "never", i = t.lastUsedCommand ? Qs(t.lastUsedCommand, 120) : null, a = t.lastResolvedPath ? Qs(t.lastResolvedPath, 120) : null; return r`
    <div class="list-item">
      <div class="list-main">
  ...
  `} function Xv(e, t) {
  const n = e.binding ?? "__default__", s = e.name?.trim() ? `${e.name} (${e.id})` : e.id, i = t.nodes.length > 0; return r`
    <div class="list-item">
      <div class="list-main">
  ...
  `} function im(e) {
  const t = e.hello?.snapshot, n = t?.uptimeMs ? Ri(t.uptimeMs) : "n/a", s = t?.policy?.tickIntervalMs ? `${t.policy.tickIntervalMs}ms` : "n/a", i = (() => {
    if (e.connected || !e.lastError) return null; const o = e.lastError.toLowerCase(); if (!(o.includes("unauthorized") || o.includes("connect failed"))) return null; const c = !!e.settings.token.trim(), u = !!e.password.trim(); return !c && !u ? r`
        <div class="muted" style="margin-top: 8px">
    ...
    `})(), a = (() => {
      if (e.connected || !e.lastError || (typeof window < "u" ? window.isSecureContext : !0)) return null; const l = e.lastError.toLowerCase(); return !l.includes("secure context") && !l.includes("device identity required") ? null : r`
      <div class="muted" style="margin-top: 8px">
  ...
  const t = e.report?.skills ?? [], n = e.filter.trim().toLowerCase(), s = n ? t.filter(a => [a.name, a.description, a.source].join(" ").toLowerCase().includes(n)) : t, i = vm(s); return r`
    <section class="card">
      ...
      ${s.length === 0 ? r`
            ...
            <div class="agent-skills-groups" style="margin-top: 16px;">
              ${i.map(a => {
    const o = a.id === "workspace" || a.id === "built-in"; return r`
...
`, Tm = 4; function at(e) { return Math.round(e / Tm) } function O(e) { return e >= 1e6 ? `${(e / 1e6).toFixed(1)}M` : e >= 1e3 ? `${(e / 1e3).toFixed(1)}K` : String(e) } function _m(e) { const t = new Date; return t.setHours(e, 0, 0, 0), t.toLocaleTimeString(void 0, { hour: "numeric" }) } function Em(e, t) { const n = Array.from({ length: 24 }, () => 0), s = Array.from({ length: 24 }, () => 0); for (const i of e) { const a = i.usage; if (!a?.messageCounts || a.messageCounts.total === 0) continue; const o = a.firstActivity ?? i.updatedAt, l = a.lastActivity ?? i.updatedAt; if (!o || !l) continue; const c = Math.min(o, l), u = Math.max(o, l), p = Math.max(u - c, 1) / 6e4; let h = c; for (; h < u;) { const d = new Date(h), f = la(d, t), m = ca(d, t), S = Math.min(m.getTime(), u), $ = Math.max((S - h) / 6e4, 0) / p; n[f] += a.messageCounts.errors * $, s[f] += a.messageCounts.total * $, h = S + 1 } } return s.map((i, a) => { const o = n[a], l = i > 0 ? o / i : 0; return { hour: a, rate: l, errors: o, msgs: i } }).filter(i => i.msgs > 0 && i.errors > 0).toSorted((i, a) => a.rate - i.rate).slice(0, 5).map(i => ({ label: _m(i.hour), value: `${(i.rate * 100).toFixed(2)}%`, sub: `${Math.round(i.errors)} errors · ${Math.round(i.msgs)} msgs` })) } const Lm = ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]; function la(e, t) { return t === "utc" ? e.getUTCHours() : e.getHours() } function Mm(e, t) { return t === "utc" ? e.getUTCDay() : e.getDay() } function ca(e, t) { const n = new Date(e); return t === "utc" ? n.setUTCMinutes(59, 59, 999) : n.setMinutes(59, 59, 999), n } function Im(e, t) { const n = Array.from({ length: 24 }, () => 0), s = Array.from({ length: 7 }, () => 0); let i = 0, a = !1; for (const l of e) { const c = l.usage; if (!c || !c.totalTokens || c.totalTokens <= 0) continue; i += c.totalTokens; const u = c.firstActivity ?? l.updatedAt, g = c.lastActivity ?? l.updatedAt; if (!u || !g) continue; a = !0; const p = Math.min(u, g), h = Math.max(u, g), f = Math.max(h - p, 1) / 6e4; let m = p; for (; m < h;) { const S = new Date(m), k = la(S, t), $ = Mm(S, t), A = ca(S, t), C = Math.min(A.getTime(), h), T = Math.max((C - m) / 6e4, 0) / f; n[k] += c.totalTokens * T, s[$] += c.totalTokens * T, m = C + 1 } } const o = Lm.map((l, c) => ({ label: l, tokens: s[c] })); return { hasData: a, totalTokens: i, hourTotals: n, weekdayTotals: o } } function Rm(e, t, n, s) {
  const i = Im(e, t); if (!i.hasData) return r`
    ...
    const c = Math.min(l.tokens / o, 1), u = l.tokens > 0 ? `rgba(255, 77, 77, ${.12 + c * .6})` : "transparent"; return r`
      ...
      const u = Math.min(l / a, 1), g = l > 0 ? `rgba(255, 77, 77, ${.08 + u * .7})` : "transparent", p = `${c}:00 · ${O(l)} tokens`, h = u > .7 ? "rgba(255, 77, 77, 0.6)" : "rgba(255, 77, 77, 0.2)", d = n.includes(c); return r`
                <div
...
`)
  ...
  `} function qm(e, t) {
  const n = jm(e), s = t === "tokens", i = e.totalTokens || 1, a = { output: ge(e.output, i), input: ge(e.input, i), cacheWrite: ge(e.cacheWrite, i), cacheRead: ge(e.cacheRead, i) }; return r`
      ...
      ${l === "recent" ? ce.length === 0 ? r`
              ...
              `: r`
                <div class="session-bars" style="max-height: 220px; margin-top: 6px;">
                  ${ce.map(E => {
    const B = A(E), ie = Y.has(E.key), ae = S(E), Z = $(E); return r`
                      <div
              ...
              `: r`
                <div class="session-bars">
                  ${_.slice(0, 50).map(E => {
      const B = A(E), ie = t.includes(E.key), ae = S(E), Z = $(E); return r`
                      <div
                        class="session-bar-row ${ie ? "selected" : ""}"
                        @click=${te => c(E.key, te.shiftKey)}
                        title="${E.key}"
      ...
      ${F > 1 ? r`
              <div style="margin-top: 10px;">
                ...
                <div class="session-bars" style="max-height: 160px; margin-top: 6px;">
                  ${se.map(E => {
        const B = A(E), ie = S(E), ae = $(E); return r`
                      <div
  ...
  `} function Qm() { return v } function Ym(e) {
  const t = e.usage; if (!t) return r`
  ...
  `} function Jm(e, t, n, s, i, a, o, l, c, u, g, p, h, d, f, m, S, k, $, A, C, _, T) {
  const I = e.label || e.key, z = I.length > 50 ? I.slice(0, 50) + "…" : I, Y = e.usage; return r`
  ...
  if (t) return r`
    ...
    <div class="session-timeseries-compact">
      ...
      <svg viewBox="0 0 ${S} ${k + 15}" class="timeseries-svg" style="width: 100%; height: auto;">
        ...
        <!-- Bars -->
        ${u.map((H, ce) => {
    const E = z[ce], B = $.left + ce * (se + F), ie = E / Y * C, ae = $.top + C - ie, te = [new Date(H.timestamp).toLocaleDateString(void 0, { month: "short", day: "numeric", hour: "2-digit", minute: "2-digit" }), `${O(E)} tokens`]; T && (te.push(`Output ${O(H.output)}`), te.push(`Input ${O(H.input)}`), te.push(`Cache write ${O(H.cacheWrite)}`), te.push(`Cache read ${O(H.cacheRead)}`)); const M = te.join(" · "); if (!T) return mn`<rect x="${B}" y="${ae}" width="${se}" height="${ie}" class="ts-bar" rx="1" style="cursor: pointer;"><title>${M}</title></rect>`; const R = [{ value: H.output, class: "output" }, { value: H.input, class: "input" }, { value: H.cacheWrite, class: "cache-write" }, { value: H.cacheRead, class: "cache-read" }]; let P = $.top + C; return mn`
  ...
  if (!e) return r`
    ...
    <div class="context-details-panel">
      ...
      <div class="context-breakdown-grid">
        ${g.length > 0 ? (() => {
      const A = g.length - m.length; return r`
                ...
                `})() : v}
        ${p.length > 0 ? (() => {
      const A = p.length - S.length; return r`
                  <div class="context-breakdown-card">
                ...
                `})() : v}
        ${h.length > 0 ? (() => {
      const A = h.length - k.length; return r`
                  <div class="context-breakdown-card">
  ...
  `} function eb(e, t, n, s, i, a, o, l, c, u) {
  if (t) return r`
    ...
    <div class="session-logs-compact">
      ...
      <div class="session-logs-list">
        ${d.map(k => {
    const { log: $, toolInfo: A, cleanContent: C } = k, _ = $.role === "user" ? "user" : "assistant", T = $.role === "user" ? "You" : $.role === "assistant" ? "Assistant" : "Tool"; return r`
  ...
  `} function tb(e) {
  if (e.loading && !e.totals) return r`
      <style>
  ...
  `} let Ks = null; const tr = e => { Ks && clearTimeout(Ks), Ks = window.setTimeout(() => { rl(e) }, 400) }, nb = /^data:/i, sb = /^https?:\/\//i; function ib(e) { const t = e.agentsList?.agents ?? [], s = vr(e.sessionKey)?.agentId ?? e.agentsList?.defaultId ?? "main", a = t.find(l => l.id === s)?.identity, o = a?.avatarUrl ?? a?.avatar; if (o) return nb.test(o) || sb.test(o) ? o : a?.avatarUrl } function ab(e) {
  const t = e.presenceEntries.length, n = e.sessionsResult?.count ?? null, s = e.cronStatus?.nextWakeAtMs ?? null, i = e.connected ? null : "Disconnected from gateway.", a = e.tab === "chat", o = a && (e.settings.chatFocusMode || e.onboarding), l = e.onboarding ? !1 : e.settings.chatShowThinking, c = ib(e), u = e.chatAvatarUrl ?? c ?? null, g = e.configForm ?? e.configSnapshot?.config, p = ln(e.basePath ?? ""), h = e.agentsSelectedId ?? e.agentsList?.defaultId ?? e.agentsList?.agents?.[0]?.id ?? null; return r`
    <div class="shell ${a ? "shell--chat" : ""} ${o ? "shell--chat-focus" : ""} ${e.settings.navCollapsed ? "shell--nav-collapsed" : ""} ${e.onboarding ? "shell--onboarding" : ""}">
      ...
      <aside class="nav ${e.settings.navCollapsed ? "nav--collapsed" : ""}">
        ${Xd.map(d => {
    const f = e.settings.navGroupsCollapsed[d.label] ?? !1, m = d.tabs.some(S => S === e.tab); return r`
